// IDEA:
// After electron is properlly initialized and user has inputed his login the main process will execute the receive login method to start the bot on the background

export default interface ILoginSubscriber {
  ReceiveLogin() : void
}
